...
public class MithrilHoeItem extends HoeItem {
    ...
    public float getMiningSpeedMultiplier(ItemStack stack, BlockState state) {
        ...
        if (BlockTags.HOE_MINEABLE.contains(state.getBlock())) {
    ...
    public boolean postMine(ItemStack stack, World world, BlockState state, BlockPos pos, LivingEntity miner) {
        AttunedItemUtil.applyMinerAttunement(stack, state.getBlock().getTranslationKey(), (PlayerEntity) miner, BlockTags.HOE_MINEABLE.contains(state.getBlock()));
